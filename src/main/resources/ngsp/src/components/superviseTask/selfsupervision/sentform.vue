  ...
  <div>
    ...
    <el-card style="margin-top: 0px;">
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="4">
          <el-select :disabled="isabledwrite" @change="changelettertype1" v-model="surverletter" placeholder=""
        ...
        <el-col :span="4">
          <el-select :disabled="isabledwrite" @change="changelettertype2" v-model="assitletter" placeholder=""
                     size="small" style="width:90%;">
            <el-option
      ...
      <el-row style="margin: 20px 0 15px 30px;">
        <el-col :span="2"><span style="color:red">*</span><span>是否需要回函</span></el-col>
        <el-col :span="5">
      ...
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span=3>
          <el-checkbox :disabled="isabledwrite" v-model="letterchecked1">综合联络人</el-checkbox>
        </el-col>
        <el-col :span=3>
          <el-checkbox :disabled="isabledwrite" v-model="letterchecked2">会籍联络人</el-checkbox>
        </el-col>
        <el-col :span=3>
          <el-checkbox :disabled="isabledwrite" v-model="letterchecked3">合规联络人</el-checkbox>
        </el-col>
        <el-col :span=3>
          <el-checkbox :disabled="isabledwrite" v-model="letterchecked4">技术联络人</el-checkbox>
        </el-col>
      </el-row>
      <el-row style="margin: 0px 0 15px 30px;">
        ...
        <el-col :span="3" v-if="sendletter" style="margin-left: -65%;margin-top:5px;color: red;">发函附件不能为空!</el-col>
      </el-row>
      <!--       <el-row style="margin: 20px 0 15px 30px;">
  ...
  export default {
    ...
    data () {
      return {
        ...
        towhom: '',
        dialogFormVisble: false,
        surverletter: '自律监管措施函',
        assitletter: '市场监察警示函—0105',
        lettermatter: '',
    ...
    methods: {
      ...
      generateletter () {
        ...
        postgenerateletter(isparams).then((resp) => {
          this.getfilelist()
        })
      },
      openwarnpage () {
      ...
      changelettertype2 () {
        this.lettercompeletenum()
      },
      changelettertype1 () {
        if (this.surverletter == '自律监管措施函') {
          this.assitletter = '市场监察警示函—0105'
          this.isassitletter = []
          this.isassitletter.push(
            {
              value: '市场监察警示函—0105',
              label: '市场监察警示函—0105'
            }, {
        ...
        if (this.surverletter == '纪律处分') {
          this.assitletter = '纪律处分意向书'
          this.isassitletter = []
          this.isassitletter.push({
            value: '纪律处分意向书',
            label: '纪律处分意向书'
      ...
      lettercompeletenum () {
        ...
        this.letterpeople = this.gfnGetRealName()
        let mydate = new Date()
        this.letterdate = mydate.getFullYear() + '-' + (mydate.getMonth() + 1) + '-' + mydate.getDate()
        let month = ''
        let day = ''
        if ((mydate.getMonth() + 1) < 10) {
          month = '0' + (mydate.getMonth() + 1)
      ...
      confirmCommitInfo () {
        ...
        let isparams = JSON.stringify(params)
        postsendletter(this.taskId, isparams).then((resp) => {
          this.goBack()
        })
      },
      getbutton () {
      ...
      getAllData () {
        getcheckform(this.instanceId).then((resp) => {
          ...
          this.lettersend = '/ngsp/bpm/v1/attachment/upload?fileLoc=sls_letter_send&infoId=' + this.infoId
          this.getfilelist()
        })
      },
      getfilelist () {
