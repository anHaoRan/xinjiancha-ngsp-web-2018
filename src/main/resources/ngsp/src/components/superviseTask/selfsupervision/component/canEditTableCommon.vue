<template>
  <el-table
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
        <el-input :disabled="disabled" v-model="scope.row.accountCode" placeholder="回车搜索账户信息" size="small"
                  @keyup.enter.native="searchAccount(scope.row)"></el-input>
      </template>
    </el-table-column>
    <el-table-column
      prop="accountName"
    ...
    <el-table-column
      ...
      show-overflow-tooltip>
      <template slot-scope="scope">
        <el-input :disabled="disabled" v-model="scope.row.contactP1" placeholder="" size="small"></el-input>
      </template>
    </el-table-column>
    <el-table-column
      prop="contactNo1"
      ...
      show-overflow-tooltip>
      <template slot-scope="scope">
        <el-input :disabled="disabled" v-model="scope.row.contactNo1" placeholder="" size="small"></el-input>
      </template>
    </el-table-column>
  </el-table>
</template>
