  ...
  <div>
    ...
    <el-card>
      ...
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="10">
          <el-input :disabled="isabledwrite" v-model="lettermessage" size="small" style="width:76%"></el-input>
        </el-col>
      </el-row>
      <el-row style="margin: 20px 0 15px 30px;">
  ...
  export default {
    ...
    methods: {
      ...
      assign (url) {
        ...
        postreturnletter(this.taskId, isparams).then((resp) => {
          this.goBack()
        })
      },
      getbutton () {
      ...
      getAllData () {
        getcheckform(this.instanceId).then((resp) => {
          ...
          this.letterresp = '/ngsp/bpm/v1/attachment/upload?fileLoc=sls_letter_resp&infoId=' + this.infoId
          this.getfilelist()
        })
      },
      getfilelist () {
