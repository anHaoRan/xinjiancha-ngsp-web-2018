  ...
  <div>
    ...
    <el-card style="margin-top: 0px;">
      ...
      <el-row style="margin: 0px 0 15px 30px;">
        ...
        <el-col :span="18">
          <el-input :disabled="String(handleStatus) === '1'" v-bind:maxlength=2000 @blur="verficationNull(logtext,4)" type="textarea" v-bind:rows=4
      ...
      <el-row>
        ...
        <el-table
          ...
          <el-table-column
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.contactP1" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="contactNo1"
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.contactNo1" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
        </el-table>
      </el-row>
    ...
    <el-card style="margin-top: 0px;">
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="18">
          <el-radio :disabled="String(handleStatus) === '1'" v-model="deailradio" label="0" @change="displaydeail">标准化监管</el-radio>
          <el-radio :disabled="String(handleStatus) === '1'" v-model="deailradio" label="1" @change="displaydeail" style="margin-left:85px">差异化监管</el-radio>
          <el-radio :disabled="String(handleStatus) === '1'" v-model="deailradio" label="2" @change="displaydeail" style="margin-left:85px">纪律处分</el-radio>
        </el-col>
      ...
      <div v-if="deailflag1">
        <el-row style="margin: 20px 0 15px 30px;" v-if="differentiationflag">
          ...
          <el-col :span="18">
            <el-radio :disabled="String(handleStatus) === '1'" v-model="differentiationadio" label="0" @change="differentradio">涉嫌庄股操纵</el-radio>
            <el-radio :disabled="String(handleStatus) === '1'" v-model="differentiationadio" label="1" @change="differentradio" style="margin-left:72px">
              频繁参与异动股炒作
            </el-radio>
            <el-radio :disabled="String(handleStatus) === '1'" v-model="differentiationadio" label="2" @change="differentradio" style="margin-left:30px">维护市场稳定
            </el-radio>
            <el-radio :disabled="String(handleStatus) === '1'" v-model="differentiationadio" label="3" @change="differentradio" style="margin-left:55px">
              其他情节较为严重的异常行为
            </el-radio>
          </el-col>
        ...
        <el-row style="margin: 20px 0 15px 30px;">
          ...
          <el-col :span="18">
            <el-checkbox :disabled="String(handleStatus) === '1'" v-model="measureradioa" @change="Undisplaysuspendtable">口头警示</el-checkbox>
            <el-checkbox :disabled="String(handleStatus) === '1'" v-model="measureradiob" @change="Undisplaysuspendtable" style="margin-left:102px">书面警示
            </el-checkbox>
            <el-checkbox :disabled="String(handleStatus) === '1'" v-model="measureradioc" @change="displaysuspendtable" style="margin-left:100px">盘中暂停交易
            </el-checkbox>
            <el-checkbox :disabled="String(handleStatus) === '1'" v-model="measureradiod" @change="displaysuspendtable" style="margin-left:55px">持续暂停交易
            </el-checkbox>
          </el-col>
        ...
        <el-row style="margin: 20px 0 15px 30px;">
          ...
          <el-col :span=2>
            <el-checkbox :disabled="String(handleStatus) === '1'" v-model="measurechecked2" style="margin-left:55px">监管谈话</el-checkbox>
          </el-col>
          <el-col :span=2>
            <el-checkbox :disabled="String(handleStatus) === '1'" v-model="measurechecked3" style="margin-left:105px">要求提交合规承诺书</el-checkbox>
          </el-col>
        </el-row>
        <el-row style="margin: 20px 0 15px 30px;">
      ...
      <div v-if="deailflag3">
        <el-row style="margin: 20px 0 15px 30px;">
          <el-col :span="3"><span style="color:red">*</span><span>监管措施</span></el-col>
          <el-col :span="3">
            <el-checkbox :disabled="String(handleStatus) === '1'" v-model="measureradio1" label="4" @change="dispalylimittable">限制交易</el-checkbox>
          </el-col>
        ...
        <el-row style="margin-left:14.1%">
          <el-col :span="3">
            <el-checkbox :disabled="String(handleStatus) === '1'" v-model="measureradio2" :label="5" @change="verfymeasureradio2">认定为不合格投资者</el-checkbox>
          </el-col>
        </el-row>
        <el-row style="margin: 20px 0 15px 30px;">
          <el-col :span="3">投资者标记</el-col>
      ...
      <el-row v-if="limittable">
        <el-table
          ...
          <el-table-column
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.accountUser" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="salepart"
          ...
          <el-table-column
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-date-picker :disabled="String(handleStatus) === '1'" v-model="scope.row.punishTime" type="date" size="small" style="width:140px"
          ...
          <el-table-column
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.punishReason" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          ...
          <el-table-column
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.restrictTime" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="violation"
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.violation" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="punishScheme"
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.punishScheme" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="accountCode"
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.accountCode" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="processPerson"
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.processPerson" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="stockTrader"
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.stockTrader" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="idcard"
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.idcard" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="documentNo"
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.documentNo" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="punishDocument"
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.punishDocument" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
        </el-table>
      </el-row>
      ...
      <el-row v-if="suspendtable">
        <el-table
          ...
          <el-table-column
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-select :disabled="String(handleStatus) === '1'" v-model="scope.row.direction" placeholder="" size="small">
                <el-option
          ...
          <el-table-column
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.stocktype" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="oneword"
          ...
          <el-table-column
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.involveStock" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="abnormalBehav1"
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.abnormalBehav1" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="abnormalBehav2"
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.abnormalBehav2" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="behavDesc"
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-input :disabled="String(handleStatus) === '1'" v-model="scope.row.behavDesc" placeholder="" size="small"></el-input>
            </template>
          </el-table-column>
          <el-table-column
            prop="isSerious"
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-select :disabled="String(handleStatus) === '1'" v-model="scope.row.isSerious" placeholder="" size="small">
                <el-option
          ...
          <el-table-column
            ...
            show-overflow-tooltip>
            <template slot-scope="scope">
              <el-select :disabled="String(handleStatus) === '1'" v-model="scope.row.pauseReason" placeholder="" size="small">
                <el-option
    ...
    <el-card style="margin-top: 0px;">
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="18">
          <el-input :disabled="String(handleStatus) === '1'" type="textarea" v-model="auditoption" placeholder="字符限制200以内" v-bind:maxlength=200 size="medium"
                    style="width:92.5%"></el-input>
        </el-col>
      </el-row>
    ...
    methods: {
      ...
      displaySelectPerson (item) {
        ...
        /* if (this.deailradio == '0') {
         ...
         if (this.deailradio == '1') {
         this.selectData.activityName = '分配处罚单'
         }
         if (this.deailradio == '2') {
         this.selectData.activityName = '分配处罚单'
         }
      ...
      changetype1 () {
        ...
        this.title = this.commonData.stockCode[0] + '-' + this.matter
      },
      analyResult () {
      ...
      getTxtData (TxtData) {
        ...
        getaccountinfo(result.join(',')).then((resp) => {
          this.warningdata = []
      ...
      submitfrom (person) {
        ...
        let isparams = JSON.stringify(params)
        postsucessform(this.flag, this.taskId, isparams, toWhom).then((resp) => {
          this.goBack()
        })
      },
