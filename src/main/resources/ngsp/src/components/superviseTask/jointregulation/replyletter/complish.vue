<template>
  <div>
    ...
    <el-card style="margin-top: 0px;">
      ...
      <el-row style="margin: 20px 0 15px 30px;">
        <el-col :span="2"><span>回函人</span></el-col>
        <el-col :span="9">
          <span>{{replypeople}}</span>
        </el-col>
        <el-col :span="3"><span>回函日期</span></el-col>
        <el-col :span="5">
          <span>{{replytime}}</span>
        </el-col>
      </el-row>
    ...
    <el-card style="margin-top: 0px;">
      <!--       <el-row style="margin: 20px 0 15px 30px;">
              ...
              <el-col :span="18">
                <el-input placeholder="字符限制200以内" v-bind:maxlength=200 type="textarea" v-model="auditoption" size="medium" style="width:92.5%"></el-input>
              </el-col>
            </el-row> -->
    ...
    methods: {
      ...
      getAllData () {
        getreplyletterform(this.instanceId).then((resp) => {
          ...
          this.replypeople = resp.unsCheckResp.respPerson
          this.replytime = resp.unsCheckResp.respDate
