  ...
  <div>
    ...
    <el-card style="margin-top: 0px;">
      ...
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="8">
          <el-input :disabled="String(handleStatus) === '1'" v-bind:maxlength=50 v-model="contact" size="small"
                    style="width: 76%;"></el-input>
        </el-col>
      </el-row>
      <el-row style="margin: 20px 0 15px 30px;">
      ...
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="18">
          <el-input :disabled="String(handleStatus) === '1'" placeholder="字符限制50以内" v-bind:maxlength=50 type="textarea"
                    v-model="remarktext" size="medium" style="width:92.5%"></el-input>
        </el-col>
      </el-row>
      <el-row style="margin: 0px 0 15px 30px;">
    ...
    <el-card style="margin-top: 0px;">
      <el-row style="margin: 20px 0 15px 30px;">
        <el-col :span="2"><span style="color:red">*</span><span>证券代码</span></el-col>
        <el-col :span="8" v-if="String(handleStatus) !== '1'">
          <stock-code-query :commonData="commonData1" @getStockCode="getStockCode1" size="small"
                            style="width:95%"></stock-code-query>
        </el-col>
        <el-col :span="8" v-if="String(handleStatus) === '1'">
          <stock-code-query :commonData="commonData2" @getStockCode="getStockCode1" size="small"
                            style="width:95%"></stock-code-query>
        </el-col>
        <el-col :span="3" v-if="nullbondcode2" class="verfynull">证券代码不能为空!</el-col>
        <el-col :span="3">
          <el-radio :disabled="String(handleStatus) === '1'" @change="isnullcode" v-model="coderadio1" label="1" style="margin-top: 8px">
            无证券代码
          </el-radio>
        </el-col>
      </el-row>
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="4">
          <el-select :disabled="String(handleStatus) === '1'" filterable v-model="surverletter" placeholder="" size="small"
                     style="width:90%;" @change="handleLetterTypeChange">
            <el-option
        ...
        <el-col :span="4">
          <el-select :disabled="String(handleStatus) === '1'" filterable v-model="assitletter" placeholder="" size="small"
                     style="width:90%;" @change="getnumber">
            <el-option
      ...
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="10">
          <el-input :disabled="String(handleStatus) === '1'" v-bind:maxlength=50 v-model="lettername" style="width:76%" size="small"
                    @change='isdisplay'></el-input>
        </el-col>
        <el-col :span="2" v-if="nulllettername" class="verfynull" style="margin-left:-1%">函件名称不能为空!</el-col>
      </el-row>
      <el-row style="margin: 20px 0 15px 30px;">
        <el-col :span="2"><span>函件事项</span></el-col>
        <el-col :span="10">
          <el-input :disabled="String(handleStatus) === '1'" v-bind:maxlength=200 v-model="lettermatter" style="width:76%"
                    size="small"></el-input>
        </el-col>
      </el-row>
      <el-row style="margin: 0px 0 15px 30px;">
        ...
        <el-col :span="4">
          <el-select :disabled="String(handleStatus) === '1'" filterable v-model="sendobject1" placeholder="" size="small"
                     style="width:90%;" @change="changesendobject2">
            <el-option
        ...
        <el-col :span="4">
          <el-select :disabled="String(handleStatus) === '1'" filterable v-model="sendobject2" placeholder="" size="small"
                     style="width:90%;" @change="handleSendObjectChange">
            <el-option
      ...
      <el-row style="margin: 0px 0 15px 30px;">
        ...
        <el-col :span="4">
          <el-select :disabled="String(handleStatus) === '1'" filterable v-model="sendletterstayle" placeholder="" size="small"
                     style="width:90%;" @change="handleSendMethodChange">
            <el-option
    ...
    <el-card style="margin-top: 0px;padding-bottom: 15px;">
      ...
      <el-row style="margin: 20px 0 15px 30px;line-height:40px;" v-if="dispalyClueReport||dispalyClueReportNumber">
        ...
        <a style="text-decoration:underline;color:blue" v-if="dispalyClueReportNumber" @click="routeClueForm">{{clueReportNumber}}</a>
  ...
  export default {
    ...
    methods: {
      ...
      displaySelectPerson () {
        ...
        if (this.nullbondcode || this.nullbondcode2) {
          return
        }
        ...
        this.selectData.activityName = '组员复核'
      ...
      getAllData () {
        getreplyletterform(this.instanceId).then((resp) => {
          ...
          if (resp.unsCheckResp == null || resp.unsCheckResp.security == null) {
          ...
          if (resp.unsCheckResp && resp.unsCheckResp.security == '') {
            this.coderadio1 = '1'
          } else if (resp.unsCheckResp == null || resp.unsCheckResp.security == null) {
            this.commonData1.stockCode = resp.unsCheckReceive.security.split(';')
            this.commonData2.stockCode = resp.unsCheckReceive.security.split(';')
          } else {
            this.commonData1.stockCode = resp.unsCheckResp.security.split(';')
            this.commonData2.stockCode = resp.unsCheckResp.security.split(';')
          }
          this.surverletter = resp.unsCheckResp ? (resp.unsCheckResp.letterType ? resp.unsCheckResp.letterType.split(' ')[0] : this.surverletter) : this.surverletter
          this.assitletter = resp.unsCheckResp ? (resp.unsCheckResp.letterType ? resp.unsCheckResp.letterType.split(' ')[1] : this.assitletter) : this.assitletter
          this.letternumber = resp.unsCheckResp ? resp.unsCheckResp.letterNo : ''
          // this.lettername=resp.unsCheckResp.letterName
          this.sendobject1 = resp.unsCheckResp ? (resp.unsCheckResp.target ? resp.unsCheckResp.target.split(' ')[0] : this.sendobject1) : this.sendobject1
          this.sendobject2 = resp.unsCheckResp ? (resp.unsCheckResp.target ? resp.unsCheckResp.target.split(' ')[1] : this.sendobject2) : this.sendobject2
          this.sendletterstayle = resp.unsCheckResp ? (resp.unsCheckResp.respWay ? resp.unsCheckResp.respWay : this.sendletterstayle) : this.sendletterstayle
          this.createpeople = resp.unsCheckResp ? (resp.unsCheckResp.drafter ? resp.unsCheckResp.drafter : this.createpeople) : this.createpeople
          this.accomplishtime = resp.unsCheckResp ? (resp.unsCheckResp.sendDate ? resp.unsCheckResp.sendDate : this.accomplishtime) : this.accomplishtime
          this.replyremarktext = resp.unsCheckResp ? (resp.unsCheckResp.note ? resp.unsCheckResp.note : this.replyremarktext) : this.replyremarktext
          this.lettermatter = resp.unsCheckResp ? (resp.unsCheckResp.extend1 ? resp.unsCheckResp.extend1 : this.lettermatter) : this.lettermatter
        })
      },
      getfilelist () {
      ...
      getnumber () {
        getnum(this.lastLetterType, this.assitletter).then((resp) => {
          this.letternumber = resp
          this.lastLetterType = this.assitletter
      ...
      getStockCode1 (stockCodeData) {
        ...
        this.nullbondcode2 = !stockCodeData.length
      },
      isnullcode () {
