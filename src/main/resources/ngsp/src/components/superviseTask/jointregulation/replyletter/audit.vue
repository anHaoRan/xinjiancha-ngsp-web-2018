  ...
  <div>
    ...
    <el-card style="margin-top: 0px;">
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="10">
          <el-input :disabled="isCreated" v-bind:maxlength=50 v-model="name" placeholder="" size="small"
                    style="width:76%"></el-input>
        </el-col>
        <el-col :span="2"><span style="color:red">*</span><span>来函编号</span></el-col>
        <el-col :span="8">
          <el-input :disabled="isCreated" v-bind:maxlength=50 v-model="number" placeholder="" size="small"
                    style="width:76%"></el-input>
        </el-col>
      </el-row>
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="4">
          <el-select :disabled="isCreated" filterable v-model="unit1" placeholder="" size="small" style="width:90%;"
        ...
        <el-col :span="6">
          <el-select :disabled="isCreated" filterable v-model="unit2" placeholder="" size="small" style="width:60%;">
            <el-option
        ...
        <el-col :span="8">
          <el-input :disabled="isCreated" v-bind:maxlength=50 v-model="contact" size="small"
                    style="width: 76%;"></el-input>
        </el-col>
      </el-row>
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="10">
          <el-input :disabled="isCreated" v-model="date" style="width:76%" size="small"></el-input>
        </el-col>
        <el-col :span="2"><span style="color:red">*</span><span>来函方式</span></el-col>
        <el-col :span="10">
          <el-select :disabled="isCreated" filterable v-model="way" placeholder="" size="small" style="width:76%;"
                     @change="changematter">
            <el-option
              v-for="item in isway"
              :key="item.value"
      ...
      <el-row style="margin: 0px 0 15px 30px;">
        ...
        <el-col :span="10">
          <el-input :disabled="isCreated" v-model="style" style="width:76%" size="small"></el-input>
        </el-col>
        <el-col :span="2"><span style="color:red">*</span><span>来函事项</span></el-col>
        <el-col :span="4">
          <el-select :disabled="isCreated" filterable v-model="matter1" placeholder="" size="small" style="width:90%;"
                     @change="changematter">
            <el-option
        ...
        <el-col :span="4">
          <el-select :disabled="isCreated" filterable v-model="matter2" placeholder="" size="small" style="width:90%;">
            <el-option
      ...
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="18">
          <el-input :disabled="isCreated" placeholder="字符限制50以内" v-bind:maxlength=50 type="textarea"
