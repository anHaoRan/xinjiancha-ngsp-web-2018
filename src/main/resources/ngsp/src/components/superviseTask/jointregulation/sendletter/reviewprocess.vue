  ...
  <div>
    ...
    <el-card style="margin-top: 0px;">
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="8">
          <el-input :disabled="true" v-model="bondcode" placeholder="" size="small" style="width:95%" type="textarea"
                    :row="1"></el-input>
        </el-col>
      ...
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="18">
          <el-input disabled placeholder="字符限制1000以内" v-bind:maxlength=1000 type="textarea" v-model="remarktext"
    ...
    <el-card style="margin-top: 0px;">
      <el-row style="margin: 20px 0 15px 30px;">
        <el-col :span="2">持续关注股票</el-col>
        <el-col :span="2">
          <el-radio v-model="isstockradio" label="1" style="margin-top: 8px">是</el-radio>
        </el-col>
        <el-col :span="2">
          <el-radio v-model="isstockradio" label="0" style="margin-top: 8px">否</el-radio>
        </el-col>
      </el-row>
      <el-row style="margin: 20px 0 15px 30px;">
      ...
      submitfrom (person) {
        ...
        let params = {
          'unsSendMain': {
            ...
            'sentDate': this.sendlettertime,
            'comment': this.auditoption,
            'isContinuousAttention': this.isstockradio,
          },
          'taskId': this.taskId,
          'instanceId': this.instanceId,
          'approve': this.flag,
        ...
        let isparams = JSON.stringify(params)
        postreviewletterprocessform(isparams).then(() => {
          this.goBack()
        })
      },
      getbutton () {
