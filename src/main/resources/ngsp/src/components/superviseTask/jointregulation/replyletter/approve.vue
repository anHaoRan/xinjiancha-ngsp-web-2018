  ...
  <div>
    ...
    <el-card style="margin-top: 0px;">
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="10">
          <el-input disabled v-model="name" placeholder="" size="small" style="width:76%"></el-input>
        </el-col>
        <el-col :span="2"><span style="color:red">*</span><span>来函编号</span></el-col>
        <el-col :span="8">
          <el-input disabled v-model="number" placeholder="" size="small" style="width:76%"></el-input>
        </el-col>
      </el-row>
      <el-row style="margin: 20px 0 15px 30px;">
        ...
        <el-col :span="8">
          <el-input disabled v-model="contact" size="small" style="width: 76%;"></el-input>
        </el-col>
      </el-row>
      <el-row style="margin: 20px 0 15px 30px;">
