<template>
  <div>
    ...
    <el-card style="margin-top: 0px;">
      ...
      <!-- <el-row style="margin: 20px 0 15px 30px;">
        <el-col :span="2"><span style="color:red">*</span><span>发函人</span></el-col>
        <el-col :span="10">
          <span>{{sendletterpeople}}</span>
        </el-col>
        <el-col :span="3"><span style="color:red">*</span><span>发函日期</span></el-col>
        <el-col :span="5">
          <span>{{sendlettertime}}</span>
        </el-col>
      </el-row> -->
    </el-card>
    <el-card>
    ...
    methods: {
      ...
      getAllData () {
        getsendletterform(this.instanceId).then((resp) => {
          ...
          this.sendletterpeople = this.gfnGetRealName()
          this.sendlettertime = moment().format('L')
          this.getfilelist()
        })
      },
      geturlparam () {
