<template>
  <div class='affirmBuiltAccountGroup'>
    ...
    <div style='text-align: right;padding: 15px'>
      <el-button type='primary' size='middle' @click='submit'>办结</el-button>
...
<script>
  ...
  import {
    getHistorySuggest, getFormInfo, getUserRoles, postFocusMonitorApproval, postFocusAccountGroupSave
