<template>
  <div class='overBuiltAccountGroup'>
...
<script>
  ...
  import {
    getHistorySuggest, getFormInfo, postFocusMonitorApproval
  ...
  export default {
    ...
    methods: {
      ...
      // },
      // addRow(){
      //   this.accountDetailData.unshift({
      //     accountId: '',
      //     accountName: '',
      //     memberName: '',
      //     ymtAccountId: '',
      ...
      //     readonly:false
      //   })
      //   console.log(this.monitorSecurityData)
      // },
      // stockEditRow(){
