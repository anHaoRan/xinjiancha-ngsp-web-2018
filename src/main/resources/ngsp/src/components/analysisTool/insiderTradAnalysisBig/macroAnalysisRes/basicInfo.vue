  ...
  <div class="basic-info">
    <el-card style="padding-top: 10px;margin-top: 0;position: relative;" class="el-card-table">
      ...
      <el-row style="margin-top: 20px;">
        <el-button type="primary" size="small" style="position: absolute;right: 15px;bottom: 20px;" @click="addAccount">
          进一步分析选中报告
        </el-button>
      </el-row>
    </el-card>
...
<script>
  import { getBasicInfo, addAccountListOfBasicinfo } from '@/service/analysisTool/insiderTradAccountAnalysisBig/index'
  ...
  export default {
    ...
    methods: {
      ...
      getResponse (taskId, pageIdx, pageRw) {
        //  20180316215907
        //  getBasicInfo('20180316215907', pageIdx, pageRw).then((resp) => {
