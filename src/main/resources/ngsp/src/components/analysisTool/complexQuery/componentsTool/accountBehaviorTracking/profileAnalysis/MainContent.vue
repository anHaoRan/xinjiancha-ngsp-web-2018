...
<script>
  ...
  import { gearAnalysis, exportGearAnalysis } from '@/service/analysisTool/complexQuery/accountBehaviorTracking'
  ...
  export default {
    ...
    computed: {
      ...mapGetters(['queryTrackForm2'])
    },
    watch: {
      'queryTrackForm2': {
        handler () {
          this.queryData = this.queryTrackForm2
          this.reqTableData(1)
        },
        deep: true
      }
