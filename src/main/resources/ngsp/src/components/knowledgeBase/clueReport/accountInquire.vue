  ...
  <div>
    <el-card>
      ...
      <el-row style="margin-top:15px">
        ...
        <el-col :span="2" style="margin-top:8px">投资者分类:</el-col>
        <el-col :span="4">
          <el-select v-model="assortment" placeholder="全部" size="small" style="width: 96%;">
            <el-option
              v-for="item in assortmentOption"
              :key="item.value"
              :label="item.label"
              :value="item.value"
            ></el-option>
        ...
        <el-col :span="4">
          <el-input style="width:90%" v-model="Account" placeholder="" size="small"></el-input>
        </el-col>
      ...
      <el-row style="margin-top:15px">
        ...
        <el-col :span="4">
          <el-select filterable remote v-model="department" :clearable="true" placeholder="全部" size="small"
    ...
    <el-dialog
      ...
      <el-form>
        <el-form-item label="导出字段：" :label-width="formLabelWidth">
          ...
          <el-row>
            <el-col :span=6>
              <el-checkbox v-model="checked18">一码通</el-checkbox>
            </el-col>
            <el-col :span=6>
              <el-checkbox v-model="checked19">投资者分类</el-checkbox>
            </el-col>
            <el-col :span=6>
              <el-checkbox v-model="checked20">账户代码</el-checkbox>
            </el-col>
            <el-col :span=6>
              <el-checkbox v-model="checked21">账户名称</el-checkbox>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span=6>
          ...
          <el-row>
            <el-col :span=6>
              <el-checkbox v-model="checked22">会员名称</el-checkbox>
            </el-col>
            <el-col :span=6>
              <el-checkbox v-model="checked23">营业部名称</el-checkbox>
            </el-col>
    ...
    methods: {
      ...
      getAllData () {
        ...
        let data = {
          ...
          'salepart': this.department,
          'pageIndex': this.currentPage,
          'pageRows': this.pagenum
        }
        postAccountInquirelist(JSON.stringify(data)).then((resp) => {
      ...
      veryfy () {
        ...
        this.tableOptions.push({label: '函件编号', field: 'letterNo', width: '120', align: 'left', isShow: this.checked0},
          ...
          {label: '一码通', field: 'oneword', width: '120', align: 'left', isShow: this.checked18},
          {label: '投资者分类', field: 'assortment', width: '120', align: 'left', isShow: this.checked19},
          {label: '账户代码', field: 'accountCode', width: '120', align: 'left', isShow: this.checked20},
          {label: '代码名称', field: 'accountName', width: '120', align: 'left', isShow: this.checked21},
          {label: '会员名称', field: 'member', width: '120', align: 'left', isShow: this.checked22},
          {label: '营业部名称', field: 'salepart', width: '120', align: 'left', isShow: this.checked23},
        ...
        this.gfnExportFileWithForm('/bpm/history/crpprocess/account/export', params)
      },
