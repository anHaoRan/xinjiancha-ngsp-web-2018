  ...
  <div>
    <el-card>
      ...
      <el-row style="margin-top:15px">
        ...
        <el-col :span="4">
          <el-select collapse-tags v-bind:multiple="true" v-model="investorClassify" placeholder="全部" size="small"
                     style="width: 90%;">
            <el-option
      ...
      <el-row style="margin-top:15px">
        ...
        <el-col :span="4">
          <el-select collapse-tags v-bind:multiple="true" v-model="regulatoryMeasure" placeholder="全部" size="small"
                     style="width: 90%;">
            <el-option
    ...
    <el-card>
      ...
      <el-table
        ...
        <el-table-column
          ...
          show-overflow-tooltip>
          <template slot-scope="scope">
            <a style="text-decoration:underline;color:#409eff;cursor:pointer;" @click="downloadfile(scope.row)">{{scope.row.fileName}}</a>
          </template>
        </el-table-column>
        <el-table-column
          prop="letterType2"
      ...
      <el-form>
        <el-form-item label="导出字段：" :label-width="formLabelWidth">
          <el-row>
            ...
            <el-col :span=6>
              <el-checkbox v-model="checked18">账户名称</el-checkbox>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span=6>
              <el-checkbox v-model="checked19">一码通</el-checkbox>
            </el-col>
            <el-col :span=6>
              <el-checkbox v-model="checked20">是否产品账户</el-checkbox>
            </el-col>
            <el-col :span=6>
            ...
            <el-col :span=6>
              <el-checkbox v-model="checked21">函件发送方式</el-checkbox>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span=6>
            ...
            <el-col :span=6>
              <el-checkbox v-model="checked22">存档情况</el-checkbox>
            </el-col>
            <el-col :span=6>
          ...
          <el-row>
            <el-col :span=6>
              <el-checkbox v-model="checked23">账户代码</el-checkbox>
            </el-col>
            <el-col :span=6>
    ...
    data () {
      return {
        ...
        tableOptions: [{label: '编号', field: 'warningNo', width: '120', align: 'left'},
          ...
          {label: '是否是产品账户', field: 'assortment', width: '120', align: 'left'},
          ...
          {label: '函件发送方式', field: 'xxxx', width: '120', align: 'left'},
          {label: '中间库状态', field: 'xxx', width: '120', align: 'left'},
          {label: '入库状态', field: 'xxx', width: '120', align: 'left'},
          {label: '存档情况', field: 'xxxx', width: '120', align: 'left'},
    ...
    methods: {
      ...
      getAllData () {
        ...
        let data = {
          ...
          // "letterNo": this.letterNumber.join(','),
        ...
        postSelfregulatoryAccountlist(JSON.stringify(data)).then((resp) => {
            ...
            for (let j = 0; j < ismeasureradio.length; j++) {
              switch (ismeasureradio[j]) {
                ...
                case '3':
                  ...
                  break
                case '4':
                  superviseScheme.push('限制交易')
                  break
                case '5':
                  superviseScheme.push('认定为不合格投资者')
                  break
              }
            }
            console.log(superviseScheme)
      ...
      veryfy () {
        /* 判断是否选择导出字段 */
        let checkList = [this.checked0, this.checked1, this.checked2, this.checked3, this.checked4, this.checked5, this.checked6, this.checked7, this.checked8, this.checked9, this.checked10, this.checked11, this.checked12, this.checked13, this.checked14, this.checked15, this.checked16, this.checked17, this.checked18, this.checked19, this.checked20, this.checked21, this.checked22, this.checked23]
        ...
        this.tableOptions.push({label: '编号', field: 'warningNo', width: '120', align: 'left', isShow: this.checked0},
          ...
          {label: '账户名称', field: 'accountName', width: '120', align: 'left', isShow: this.checked18},
          {label: '账户代码', field: 'accountCode', width: '120', align: 'left', isShow: this.checked23},
          {label: '一码通', field: 'oneword', width: '120', align: 'left', isShow: this.checked19},
          {label: '是否是产品账户', field: 'assortment', width: '120', align: 'left', isShow: this.checked20},
          ...
          {label: '函件发送方式', field: 'xxxx', width: '120', align: 'left', isShow: this.checked21},
          ...
          {label: '存档情况', field: 'xxxx', width: '120', align: 'left', isShow: this.checked22},
        ...
        this.gfnExportFileWithForm('/bpm/history/slsprocess/account/export', params)
      },
