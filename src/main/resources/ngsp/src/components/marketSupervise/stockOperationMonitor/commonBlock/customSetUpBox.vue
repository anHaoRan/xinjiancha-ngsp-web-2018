  ...
  <el-row :gutter="20" class="customBox">
    <el-col :span="7">
      ...
      <el-dialog width="50%" title="手动选择" :visible.sync="isChooseStockBox" append-to-body>
        <handChooseBox @refreshCancelBox="isChooseStockBox = false" @refreshSaveBox="refreshSaveFunc"></handChooseBox>
      </el-dialog>
      <el-card>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      refreshSaveFunc (data) {
        this.isChooseStockBox = false
        this.stockCodeTags = data
      }
    },
    mounted () { }
  }
